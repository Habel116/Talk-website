  ...
  return (
    <Layout>
      ...
      <section className="pt-40 pb-6 bg-gradient-to-b from-secondary to-background relative overflow-hidden">
        ...
        <div className="absolute top-12 -right-12 w-56 h-56 bg-gradient-to-bl from-accent/40 to-white/30 rounded-[45%_55%_60%_40%/50%_45%_55%_50%] shadow-[0_22px_45px_-12px_rgba(0,0,0,0.1)]" />
      ...
      <section className="section-padding bg-background relative overflow-hidden">
        {/* Decorative blob elements */}
        <div className="absolute -top-10 -left-16 w-60 h-60 bg-gradient-to-br from-secondary/40 to-accent/25 rounded-[50%_50%_40%_60%/40%_50%_50%_60%] shadow-[0_20px_42px_-12px_rgba(0,0,0,0.08)]" />
        <div className="absolute bottom-20 -right-12 w-52 h-52 bg-gradient-to-tl from-accent/30 to-secondary/35 rounded-[40%_60%_55%_45%/55%_45%_55%_45%] shadow-[0_16px_36px_-10px_rgba(0,0,0,0.06)]" />
        <div className="container-custom relative">
          {/* Year Tabs */}
          <ScrollReveal>
